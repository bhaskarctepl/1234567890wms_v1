...
public class Message {
	 ...
	 */
	@ApiModelProperty(value = "A distinct code defined by application per error condition")
	@JsonProperty("code")
	private String code;
	 ...
	 */
	@ApiModelProperty(value = "Internationalized message providing a brief description of the error condition")
	...
	@ApiModelProperty(value = "A distinct key that can be used by consuming application for mapping the WEARABLES error code to client side")
	@JsonProperty("key")
	private String key;
