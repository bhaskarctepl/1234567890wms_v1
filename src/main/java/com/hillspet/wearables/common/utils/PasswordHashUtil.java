...
public class PasswordHashUtil {
	...
	public static void main(String[] args) {
		try {
			...
			/*
			// Print out 10 hashes for (int i = 0; i < 10; i++)
			...
			*/
			...
			String password1 = "Hello@123";
			String hash = createHash(password);
			String secondHash = createHash(password1);

			System.out.println(hash);
			System.out.println(secondHash);

			System.out.println(hash.equals(secondHash));
			...
			if (validatePassword(password, secondHash)) {
				System.out.println("second hash true");
			} else {
				System.out.println("second hash false");
			}
