...
public class PetServiceImpl implements PetService {
	...
	public PetWeightDTO updateWeight(UpdatePetWeight updatePetWeight) throws ServiceExecutionException {
		...
		LOGGER.debug("updateWeight completed successfully");
		return petWeightDTO;
	}
	...
	public ImageScoringScalesResponse getPetImageScoringScales(int petId) throws ServiceExecutionException {
		...
		LOGGER.debug("getPetImageScoringScales end");
		return response;
	}
	...
	public List<PetDTO> getPetsByPetParentIdAndMobileAppConfigId(int petParentId, int mobileAppConfigId)
		...
		List<PetDTO> pets = petDao.getPetsByPetParentIdAndMobileAppConfigId(petParentId, mobileAppConfigId);
		LOGGER.debug("getPetsByPetParentIdAndMobileAppConfigId completed successfully");
		return pets;
	}
	
	@Override
	public BehaviorVisualizationResponse getBehaviorVisualization(int petId)
			throws ServiceExecutionException {
	...
	public void replaceSensorToPet(AssignSensorRequest assignSensorRequest) throws ServiceExecutionException {
		...
		petDao.replaceSensorToPet(assignSensorRequest);
		LOGGER.debug("replaceSensorToPet completed successfully");
	}

	@Override
	public void saveForwardMotionGoal(FMGoalSettingRequest fmGoalSettingRequest) {
		LOGGER.debug("saveForwardMotionGoal called");
		petDao.saveForwardMotionGoal(fmGoalSettingRequest);
		LOGGER.debug("saveForwardMotionGoal completed successfully");
	}
